...
import { carousel_DEFAULTS } from '@primitives/CarouselPrim/store/useCarouselStore.hook'
...
import { scroll_DEFAULTS } from '@primitives/ScrollPrim/store/useScrollStore.hook'
import { sliderStore } from '@primitives/SliderPrim/store/slider.store'
import { slider_DEFAULTS } from '@primitives/SliderPrim/store/useSliderStore.hook'
