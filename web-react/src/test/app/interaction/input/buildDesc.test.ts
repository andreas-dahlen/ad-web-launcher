import { testBuildDesc } from '@test/testApi.ts'
import { domQuery } from '@interaction/input/domQuery.ts'
import type { DomMeta } from '@interaction/types/descriptor/base.types.ts'
import { createMetaByType } from '@test/app/interaction/builders/domAndMeta.factory.ts'
import { createMetaContext } from '@test/testUtils/createTestContext.utils.ts'
...
import type { CarouselBinding } from '@primitives/Carousel/store/carousel.store.ts'
...
import type { ScrollBinding } from '@primitives/Scroll/store/scroll.store.ts'
import { compileDescriptor } from '@interaction/input/buildDesc.ts'
type BuildFn =
  | "buildCarousel"
  | "buildSlider"
  | "buildDrag"
