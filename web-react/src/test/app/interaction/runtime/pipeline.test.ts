...
import type { InterpreterOutput } from '@interaction/types/runtime/interpreter.types'
import { testPipeline } from '@test/testAPI'
import { domUpdater } from '@interaction/updater/domUpdater'
import { createBaseInteraction } from '@test/app/interaction/builders/base.factory'
import { createComputedScroll, createComputedSlider } from '@test/app/interaction/builders/computed.factory'
import { createCarouselData } from '@test/app/interaction/builders/data.factory'
import { createInterpreterPress, createInterpreterPressRelease, createInterpreterSwipe, createInterpreterSwipeCommit, createInterpreterSwipeStart } from '@test/app/interaction/builders/input.factory'
