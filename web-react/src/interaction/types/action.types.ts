import type { ComputedPackage } from '@interaction/types/computed.types';
...
import type { Press, Swipe, SwipeCommit, SwipeRevert, SwipeStart } from '@typing/core.types';
...
// export type ScrollRouterAction =
//   | SwipeStart & (ScrollStart | ScrollOverflowStart)
//   | Swipe & (ScrollSwipe | ScrollOverflowSwipe)
//   | SwipeCommit & (ScrollCommit | ScrollOverflowCommit)
//   | SwipeRevert & ScrollOverflowRevert
...
// type ScrollActionStart = SwipeStart & ScrollStart
// type ScrollActionSwipe = Swipe & ScrollSwipe
// type ScrollActionCommit = SwipeCommit & ScrollCommit

// type ScrollOverflowActionStart = SwipeStart & ScrollOverflowStart
// type ScrollOverflowActionSwipe = Swipe & ScrollOverflowSwipe
// type ScrollOverflowActionCommit = SwipeCommit & ScrollOverflowCommit
// type ScrollOverflowActionRevert = SwipeRevert & ScrollOverflowRevert