...
import { layoutStore, type Scene } from '@app/compositions/layout.store';
...
export default function SceneLayoutOverlay({
  ...
  return (
    <>
      <div className={clsx(css.sceneconfig)}>
        <p>current: {sceneIdx}</p>
        <div className={clsx(css.buttons, horizontal && css.vertical, !horizontal && css.vertical)}>
