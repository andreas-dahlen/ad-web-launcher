...
describe('[DASX]', () => {
  ...
  it("should merge multiple states with later values overriding earlier ones", () => {
    expect(
      dasx(
  ...
  it("should keep empty strings as valid attribute values", () => {
    expect(
      dasx({ label: "" }),
    ).toEqual({
      "data-label": "",
