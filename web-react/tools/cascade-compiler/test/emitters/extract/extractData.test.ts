...
vi.mock(
  '../../../src/emitters/extract/assemblers/assembleTokenData.js',
)

vi.mock(
  '../../../src/emitters/extract/assemblers/assemblePresetData.js',
)

vi.mock(
  '../../../src/emitters/extract/assemblers/assembleLspData.js',
)

vi.mock(
  '../../../src/emitters/extract/assemblers/assembleExtensionData.js',
)
...
describe('[EMITTERS]', () => {
  describe('extractData', () => {
    ...
    it('assembles token data for all groups, while only emitting processed token files', () => {
      ...
      expect(assembleTokenData)
        .toHaveBeenNthCalledWith(1, group)

      expect(assembleTokenData)
        .toHaveBeenNthCalledWith(2, runGroup)
