...
import {} from '../../types/issueCollector.types.js';
export function compileTokenGroups(rootPath, tokenPaths) {
    const groupPaths = [
    ...
    for (const groupPath of groupPaths) {
        groups.set(groupPath, buildTokenGroup(groupPath, [], cssMap.get(groupPath)));
    }
    // attach tokens
