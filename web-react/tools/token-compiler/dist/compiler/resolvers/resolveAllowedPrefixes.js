...
const priority = new Map(prefixPriority.map((prefix, index) => [prefix, index]));
function getPriority(prefix) {
    return priority.get(prefix);
}
export function resolveAllowedPrefixes(allowed, alwaysAllowed, exclude, collector) {
