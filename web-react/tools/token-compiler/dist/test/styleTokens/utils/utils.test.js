...
import { colors, ESC, formatLogPath, paint, } from '@styleTokens/utils/string.ts';
describe('[CONSOLE]', () => {
    describe('formatLogPath', () => {
        it('normalizes Windows separators', () => {
            expect(
            // eslint-disable-next-line unicorn/prefer-string-raw
            formatLogPath('C:\\project\\src\\Button\\Button.module.css')).toBe('Button/Button.module.css');
        });
        it('keeps only the final two path segments', () => {
            expect(formatLogPath('/project/src/components/Button.module.css')).toBe('components/Button.module.css');
        });
        it('handles a path with fewer than two segments', () => {
            expect(formatLogPath('Button.module.css')).toBe('Button.module.css');
        });
    });
    describe('paint', () => {
